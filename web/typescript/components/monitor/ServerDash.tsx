...
export default class ServerDash extends React.Component<any, any> {
	...
	render() {
		...
		//网络IO
		const networkIOLineOpt = createNetworkIOLineOption(networkIO)
		...
		return (
			<div>
				<PanelGroup>
					...
					<BasicChartPanel title="网络IO-接收发送字节数" width="950px" height="270px"
						chartWidth="100%" chartHeight="240px" chartOption={networkIOLineOpt} showLoader={loaders.networkIO}/>
				</PanelGroup>
